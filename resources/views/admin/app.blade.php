        ...
        <div class="h-100" id="leftside-menu-container" data-simplebar>
            <ul class="side-nav">
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="insightPages">
                        <ul class="side-nav-second-level">
                            ...
                            @can('insight-list')
                                <li>
                                    <a href="{{route('insight.section')}}">Insight</a>
                                </li>
                            @endcan
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="aboutPages">
                        <ul class="side-nav-second-level">
                            ...
                            @can('join-list')
                            <li>
                                <a href="{{route('join.section')}}">Join Us</a>
                            </li>
                            @endcan
                ...
                <li class="side-nav-item">
                    ...
                    <div class="collapse" id="leadershipPages">
                        <ul class="side-nav-second-level">

                                @can('leadership-list')
                                <li>
                                    <a href="{{route('leadership.section')}}">Leadership</a>
                                </li>
                                @endcan

                                @can('goal-list')
                                <li>
                                    <a href="{{route('goal.section')}}">Our Goal</a>
                                </li>
                                @endcan
