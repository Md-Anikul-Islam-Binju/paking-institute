        ...
        <div class="page-title-box">
            <div class="page-title-right">
                <ol class="breadcrumb m-0">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Management Board & Expertise</a></li>
                    <li class="breadcrumb-item active">Management Board & Expertise</li>
                </ol>
            </div>
            <h4 class="page-title">Management Board & Expertise</h4>
        </div>
    </div>
</div>
